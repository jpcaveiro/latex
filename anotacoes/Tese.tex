...
%   \euro <= comando que desenha o euro €
%   \<espaço>  <= serve mais para terminar o comando \euro
%   \euro\ e amanhã compramos fruta
%   Escrevendo:
%        \euro e amanhã compramos fruta
%   temos o resultado
%        euroe amanhã compramos fruta
...
% para obtenção de ºC com  \textcelsius
\usepackage{textcomp}
...
% contém os elementos a alterar para a dissertação 
\include{capa}  %inclusão de um ficheiro capa.tex que é necessário abrir e procurar os elementos
